...
- ⚠️ **Ранняя версия** - ограниченная функциональность
...
- **Проблемы**: Значительные для ранней версии
...
- 💡 **Решение**: Планируется в v0.3.0+ (батчевые обновления, сохранение состояния)
